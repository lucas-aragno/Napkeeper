...
var config = {
  ...
  vendor: {
    js: [
      ...
      './bower_components/FlipClock-master/compiled/flipclock.min.js',
    ...
    fonts: [
      ...
      './bower_components/FlipClock-master/compiled/flipclock.css'
    ]
  },
...
gulp.task('js', function() {
    streamqueue({ objectMode: true },
      ...
      gulp.src(['src/templates/**/*.html']).pipe(templateCache({ module: 'NapKeeper' }))
    )
